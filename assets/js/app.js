 ...
 * @param {string} eventType eventTypeEvent Type e.g. : "click", "mouseover"
...
export const updateWeather = function (lat, lon) {
    ...
    if (window.location.hash === "#/current-location") {
        currentLocattionBtn.setAttribute("disable", "");
    } else {
        currentLocattionBtn.removeAttribute("disabled");
    }
        ...
        card.innerHTML = `
            ...
            <div class="weapper">
               ...
               <img src="./assets/images/weather_icons/${icon}.png" width="64"
                        height="64" alt="${description}" class="weather_icon">
            </div>
